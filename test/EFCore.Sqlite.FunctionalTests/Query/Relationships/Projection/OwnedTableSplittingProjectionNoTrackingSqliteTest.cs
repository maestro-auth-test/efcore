...
public class OwnedTableSplittingProjectionNoTrackingSqliteTest
    : OwnedTableSplittingProjectionNoTrackingRelationalTestBase<OwnedTableSplittingRelationshipsSqliteFixture>
{
    public OwnedTableSplittingProjectionNoTrackingSqliteTest(OwnedTableSplittingRelationshipsSqliteFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
